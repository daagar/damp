function daagar.map:setCustomColors()
  ...
  setCustomEnvColor(daagar.map.terrain["road_crossroads"], unpack(color_table.burlywood))
  setCustomEnvColor(daagar.map.terrain["crossroad_nw"], unpack(color_table.burlywood))
  setCustomEnvColor(daagar.map.terrain["crossroad_se"], unpack(color_table.burlywood))
  setCustomEnvColor(daagar.map.terrain["crossroad_ews"], unpack(color_table.burlywood))
  ...
  setCustomEnvColor(daagar.map.terrain["field"], unpack(color_table.yellow_green))
